...
print("======================")
print("Frecuencia de TRUE:", resultsTrue1000.count(True))
print("Frecuencia relativa de TRUE:", resultsTrue1000.count(True)/1000)

print("")
print("Frecuencia de FALSE:", resultsFalse1000.count(True))
print("Frecuencia relativa de FALSE:", resultsFalse1000.count(True)/1000)
print("")
...
print("======================")
print("Frecuencia de TRUE:", resultsTrue10000.count(True))
print("Frecuencia relativa de TRUE:", resultsTrue10000.count(True)/10000)

print("")
print("Frecuencia de FALSE:", resultsFalse10000.count(True))
print("Frecuencia relativa de FALSE:", resultsFalse10000.count(True)/10000)
print("")
...
print("======================")
print("Frecuencia de TRUE:", resultsTrue100000.count(True))
print("Frecuencia relativa de TRUE:", resultsTrue100000.count(True)/100000)

print("")
print("Frecuencia de FALSE:", resultsFalse100000.count(True))
print("Frecuencia relativa de FALSE:", resultsFalse100000.count(True)/100000)
print("")